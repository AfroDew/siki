...
const STYLES_INPUT_DIRECTORY = "app/styles/css";
...
async function buildStyles(path: string) {
  try {
    ...
    const outputPath = `./app/static/${relative(__dirname, path)}`;
...
const stylesOutputDirectory = `app/static/${STYLES_INPUT_DIRECTORY}`;
